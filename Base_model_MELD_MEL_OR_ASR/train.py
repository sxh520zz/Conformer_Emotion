...
with open('Train_data_Multi_Speaker.pickle', 'rb') as file:
...
parser.add_argument('--utt_insize_1', type=int, default=120)
parser.add_argument('--utt_insize_2', type=int, default=144)
...
utt_net = Model(args.utt_insize_1, args.hidden_layer, args.out_class, args)
if args.cuda:
