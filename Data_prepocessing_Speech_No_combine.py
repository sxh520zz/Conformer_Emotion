...
Spec_dir = '/media/shixiaohan-toda/70e9f22b-13a4-429e-acad-a8786e1f1143/DataBase/Experiment_Data/Babble/SNR_-5/'
...
def Read_IEMOCAP_Spec():
    ...
    train_num = 0
    train_mel_data = []
    for sess in os.listdir(Spec_dir):
        file_dir = os.path.join(Spec_dir, sess)
...
if __name__ == '__main__':
    ...
    file = open('Speech_data_Babble_-5.pickle', 'wb')
