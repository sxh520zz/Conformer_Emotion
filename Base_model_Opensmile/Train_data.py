...
with open('../train_data_map_for-Mulit-speaker_old.pickle', 'rb') as file:
    train_data= pickle.load(file)
with open('../test_data_map_for-Mulit-speaker_old.pickle', 'rb') as file:
    dev_data = pickle.load(file)
with open('../dev_data_map_for-Mulit-speaker_old.pickle', 'rb') as file:
        ...
        for j in range(len(train_data_ALL[i])):
            ...
            if (train_data_ALL[i][j]['Emotion']in label_list):
                ...
                if(train_data_ALL[i][j]['Emotion'] == 3):
                    label_3 = label_3 + 1
                a['trad_data'] = train_data_ALL[i][j]['Audio']
